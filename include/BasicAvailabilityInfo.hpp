...
public:
	...
	public:
		...
		void setReference(BasicAvailabilityInfo * r) { reference = r; }
...
public:
	...
	virtual BasicAvailabilityInfo * clone() const { return new BasicAvailabilityInfo(*this); }
	...
	// This is documented in BasicMsg
	std::string getName() const { return std::string("BasicAvailabilityInfo"); }
};
