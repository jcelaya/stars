...
public:
	...
	virtual InitStructNodeMsg * clone() const { return new InitStructNodeMsg(*this); }

	// Getters and Setters

	bool isFatherValid() const { return fatherValid; }
	 ...
	 */
	void setFather(const CommAddress & p) { father = p; fatherValid = true; }
	...
	// This is documented in BasicMsg
	std::string getName() const { return std::string("InitStructNodeMsg"); }
};
