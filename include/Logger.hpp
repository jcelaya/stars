...
public:
	...
	public:
		...
		friend std::ostream & operator<<(std::ostream & os, const AbstractTypeContainer & r) { r.output(os); return os; }
	};
	...
	public:
		...
		const AbstractTypeContainer * getSerializableVersion() const { return this; };
		void output(std::ostream & os) const { os << (std::string)(*value); }
	};
	...
	public:
		...
		const AbstractTypeContainer * getSerializableVersion() const { return this; }
		void output(std::ostream & os) const { os << value; }
	};
	...
	public:
		...
		~TypeReference() { if (del) delete value; }
		void output(std::ostream & os) const { os << *value; }
	};
