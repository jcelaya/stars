...
public:
	 ...
	 */
	const boost::shared_ptr<StretchInformation> & getBranchInfo() const { return waitingInfo; }

	/**
	 * Provides the information for this branch.
	 * @returns Pointer to the sent StretchInformation.
	 */
	const boost::shared_ptr<StretchInformation> & getNotifiedInfo() const { return ntfFatherInfo; }
