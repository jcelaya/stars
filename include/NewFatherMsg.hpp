...
public:
	...
	virtual NewFatherMsg * clone() const { return new NewFatherMsg(*this); }
	 ...
	 */
	void setFather(const CommAddress & addr) { father = addr; }
	...
	// This is documented in BasicMsg
	std::string getName() const { return std::string("NewFatherMsg"); }
};
