...
public:
	...
	public:
		...
		void setReference(QueueBalancingInfo * r) { reference = r; }

		// Order by maxT value
		bool operator<(const MDPTCluster & r) const { return maxT < r.maxT; }
		...
		static std::string getName() { return std::string("MDPTCluster"); }
...
public:
	...
	virtual QueueBalancingInfo * clone() const { return new QueueBalancingInfo(*this); }
	...
	void setMinQueueLength(Time q) { minQueue = q; }

	Time getMinQueueLength() const { return minQueue; }
	...
	// This is documented in BasicMsg
	std::string getName() const { return std::string("QueueBalancingInfo"); }
};
