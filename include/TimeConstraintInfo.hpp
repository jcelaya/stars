...
public:
	...
	public:
		...
		bool isFree() const { return points.empty(); }
		...
		const std::vector<std::pair<Time, uint64_t> > & getPoints() const { return points; }
	...
	public:
		...
		void setReference(TimeConstraintInfo * r) { reference = r; }
...
public:
	...
	static void setNumRefPoints(unsigned int n) { numRefPoints = n; }

	// This is documented in BasicMsg
	virtual TimeConstraintInfo * clone() const { return new TimeConstraintInfo(*this); }
	...
	// This is documented in BasicMsg
	std::string getName() const { return std::string("TimeConstraintInfo"); }

	const ClusteringVector<MDFCluster> & getSummary() const { return summary; }
};
