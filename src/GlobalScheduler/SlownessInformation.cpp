...
SlownessInformation::LAFunction::LAFunction(list<TaskProxy> curTasks,
...
void SlownessInformation::setAvailability(uint32_t m, uint32_t d, const list<TaskProxy> & curTasks,
