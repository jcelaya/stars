...
static struct lcinstantiate{
	lcinstantiate() {
		...
		{ const TimeConstraintInfo::ATFunction * f[2] = {&d, &d}; double c[2]; TimeConstraintInfo::ATFunction().lc(f, c); }
		{ const TimeConstraintInfo::ATFunction * f[3] = {&d, &d, &d}; double c[3]; TimeConstraintInfo::ATFunction().lc(f, c); }
		{ const TimeConstraintInfo::ATFunction * f[4] = {&d, &d, &d, &d}; double c[4]; TimeConstraintInfo::ATFunction().lc(f, c); }
		{ const TimeConstraintInfo::ATFunction * f[5] = {&d, &d, &d, &d, &d}; double c[5]; TimeConstraintInfo::ATFunction().lc(f, c); }
	}
} lcinstantiate_var;
