...
public:
	...
	Ping * clone() const { return new Ping(*this); }

	// This is documented in BasicMsg
	void output(std::ostream& os) const {}

	// This is documented in BasicMsg
	std::string getName() const { return std::string("Ping"); }
};
...
public:
	...
	Pong * clone() const { return new Pong(*this); }

	// This is documented in BasicMsg
	void output(std::ostream & os) const {}

	// This is documented in BasicMsg
	std::string getName() const { return std::string("Pong"); }
};
